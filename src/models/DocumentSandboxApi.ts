...
export interface DocumentSandboxApi {
    createRectangle({width, height, color,  x, y, textContent, textAlignment, strokeColor, strokeWidth}): any;
    ...
    createColumn ({columnIndex, columnWidth, rowHeight, gutter, color, textContent, textAlignment, strokeColor, strokeWidth}): any
