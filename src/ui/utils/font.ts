...
export const tableStyles: ITableStyle[] = [
    ...
    { id: 6, name: "Basic purple", image: "table_purple.png", colors: { header: "#662B8C", row: "#A69AB7", stroke: "white", alt_row: "#DBCAE8", row_text: "white", alt_row_text: "#643E7D", header_text: "white" }, isActive: false, border: '#662B8C' },
    { id: 7, name: "Basic brown", image: "table_brown.png", colors: { header: "#661F03", row: "#D8C29E", stroke: "white", alt_row: "#F0E5D0", row_text: "white", alt_row_text: "#9A5F48", header_text: "white" }, isActive: false, border: '#661F03' },
    { id: 8, name: "Basic deep blue", image: "table_blue_2.png", colors: { header: "#0019FF", row: "#D2D8FC", stroke: "white", alt_row: "#B1C0E8", row_text: "#5760AC", alt_row_text: "white", header_text: "white" }, isActive: false, border: '#0019FF' },
    { id: 9, name: "Basic red", image: "table_red.png", colors: { header: "#E01414", row: "#F4BFBD", stroke: "white", alt_row: "#DD8787", row_text: "white", alt_row_text: "white", header_text: "white" }, isActive: false, border: '#E01414' },
    { id: 10, name: "Basic yellow", image: "table_yellow.png", colors: { header: "#FFD60B", row: "#FCECAC", stroke: "white", alt_row: "#E5D298", row_text: "#C48A3F", alt_row_text: "white", header_text: "white" }, isActive: false, border: '#FFD60B' },
    { id: 11, name: "Simple table", image: "table_2.png", colors: { header: "white", row: "#CCCCCC", stroke: "#666666", alt_row: "white", row_text: "white", alt_row_text: "#727272", header_text: "black" }, isActive: false, border: '#CCCCCC' },
